...
public class ViaMCP {
    ...
    public ViaMCP() {
        ViaLoadingBase.ViaLoadingBaseBuilder.create().runDirectory(new File(System.getProperty("java.io.tmpdir"))).nativeVersion(NATIVE_VERSION).onProtocolReload(protocolVersion -> {
