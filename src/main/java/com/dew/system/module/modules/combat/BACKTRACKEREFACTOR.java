...
public class BACKTRACKEREFACTOR extends Module {
    ...
    private final List<Packet<INetHandlerPlayClient>> storagePackets = new ArrayList<>();
    private final List<Entity> storageEntities = new ArrayList<>();
    ...
    public BACKTRACKEREFACTOR() {
        super("Backtrack Recode", ModuleCategory.COMBAT, Keyboard.KEY_NONE, false, true, true);
    }
    ...
    private void releasePackets() {
        ...
        while (!storagePackets.isEmpty()) {
            Packet<INetHandlerPlayClient> pkt = storagePackets.remove(0);
            try {
                PacketUtil.sendPacketAsSilent(pkt);
