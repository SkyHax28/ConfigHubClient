...
public abstract class Shader {
    ...
    public Shader(final String fragmentShader) {
        ...
        try {
            final InputStream vertexStream = getClass().getResourceAsStream("/assets/minecraft/dew/shader/vertex.vert");
            ...
            final InputStream fragmentStream = getClass().getResourceAsStream("/assets/minecraft/dew/shader/fragment/" + fragmentShader);
