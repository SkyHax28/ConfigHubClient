...
public abstract class GuiScreen extends Gui implements GuiYesNoCallback
{
    ...
    {
        CommandManager commandManager = DewCommon.commandManager;
        if (msg.startsWith(commandManager.commandPrefix)) {
            String cmd = msg.substring(commandManager.commandPrefix.length());
