...
public class GuiIngameMenu extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(disconnectButton = new GuiButton(8, this.width / 2 + 2, this.height / 4 + 120 + i, 98, 20, "Reconnect"));
        ...
        disconnectButton.enabled = !this.mc.isIntegratedServerRunning() && !this.mc.isSingleplayer();
    }
