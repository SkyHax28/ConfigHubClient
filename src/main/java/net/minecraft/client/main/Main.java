...
public class Main
{
    public static void main(String[] p_main_0_)
    {
        ...
        OptionSpec<String> optionspec21 = optionparser.accepts("clientUsername").withRequiredArg().defaultsTo("null", new String[0]);
        ...
        DataSaver.userName = optionspec21.value(optionset);
