...
public class RenderPlayer extends RendererLivingEntity<AbstractClientPlayer>
{
    ...
    public void doRender(AbstractClientPlayer entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        if (!entity.isUser() || this.renderManager.livingPlayer == entity)
        {
            ...
            if (DewCommon.moduleManager.getModule(Highlighter.class).isEnabled()) {
    ...
    protected void renderOffsetLivingLabel(AbstractClientPlayer entityIn, double x, double y, double z, String str, float p_177069_9_, double p_177069_10_)
    {
        if (p_177069_10_ < 100.0D)
        {
            ...
            if (scoreobjective != null)
            {
                ...
                this.renderLivingLabel(entityIn, score.getScorePoints() + " " + scoreobjective.getDisplayName(), x, y, z, 64, DewCommon.moduleManager.getModule(NameTags.class).isEnabled() && DewCommon.moduleManager.getModule(NameTags.class).shouldRender(entityIn));
