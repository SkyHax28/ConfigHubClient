...
public abstract class Render<T extends Entity> implements IEntityRenderer
{
    ...
    protected void renderName(T entity, double x, double y, double z)
    {
        ...
        {
            this.renderLivingLabel(entity, entity.getDisplayName().getFormattedText(), x, y, z, 64, DewCommon.moduleManager.getModule(NameTags.class).isEnabled() && DewCommon.moduleManager.getModule(NameTags.class).shouldRender(entity));
        }
    }
    ...
    {
        this.renderLivingLabel(entityIn, str, x, y, z, 64, DewCommon.moduleManager.getModule(NameTags.class).isEnabled() && DewCommon.moduleManager.getModule(NameTags.class).shouldRender(entityIn));
    }
