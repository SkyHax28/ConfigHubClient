...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void onUpdateWalkingPlayer()
    {
        ...
        float yaw = preMotionEvent.yaw;
        float pitch = preMotionEvent.pitch;
        ...
        if (this.isCurrentViewEntity())
        {
            ...
            if (this.ridingEntity == null)
            {
                ...
                {
                    this.sendQueue.addToSendQueue(new C03PacketPlayer.C05PacketPlayerLook(yaw, pitch, preMotionEvent.onGround));
                }
                else
                {
            ...
            {
                this.sendQueue.addToSendQueue(new C03PacketPlayer.C06PacketPlayerPosLook(preMotionEvent.x, -999.0D, preMotionEvent.z, yaw, pitch, preMotionEvent.onGround));
                flag2 = false;
            }
    ...
    public void onLivingUpdate()
    {
        ...
        if (this.isUsingItem() && !this.isRiding() && !DewCommon.moduleManager.getModule(NoSlow.class).canNoSlow()) {
        ...
        if (this.onGround && !flag1 && !flag2 && this.movementInput.moveForward >= f && !this.isSprinting() && flag3 && (!this.isUsingItem() || DewCommon.moduleManager.getModule(NoSlow.class).canNoSlow()) && !this.isPotionActive(Potion.blindness))
        {
            ...
            else if (!DewCommon.moduleManager.getModule(Sprint.class).shouldNotSprint()) {
                this.setSprinting(true);
            }
        }

        if (!DewCommon.moduleManager.getModule(Sprint.class).shouldNotSprint() && !this.isSprinting() && this.movementInput.moveForward >= f && flag3 && (!this.isUsingItem() || DewCommon.moduleManager.getModule(NoSlow.class).canNoSlow()) && !this.isPotionActive(Potion.blindness) && this.mc.gameSettings.keyBindSprint.isKeyDown()) {
            this.setSprinting(true);
        }

        if (DewCommon.moduleManager.getModule(Sprint.class).shouldNotSprint() || this.isSprinting() && ((!DewCommon.moduleManager.getModule(Sprint.class).shouldNotSprint() || DewCommon.moduleManager.getModule(Sprint.class).isEnabled()) && (this.movementInput.moveForward < f || this.isCollidedHorizontally) || !flag3))
        {
            this.setSprinting(false);
        }
