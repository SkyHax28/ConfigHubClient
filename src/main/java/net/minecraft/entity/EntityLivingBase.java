...
public abstract class EntityLivingBase extends Entity
{
    ...
    public void onLivingUpdate()
    {
        ...
        if (Math.abs(this.motionX) < MovePatcher.handlePosition())
        {
            this.motionX = 0.0D;
        }

        if (Math.abs(this.motionY) < MovePatcher.handlePosition())
        {
            this.motionY = 0.0D;
        }

        if (Math.abs(this.motionZ) < MovePatcher.handlePosition())
        {
            this.motionZ = 0.0D;
        }
